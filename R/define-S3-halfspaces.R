#' @title Define S3-class halfspaces
#' @description
#' Define a new S3 class `halfspaces`.
...
#'
#' @seealso
#' [train_depth()], [halfspace()], [update.halfspaces()],
...
#' @describeIn halfspaces a low level constructor for class halfspaces
new_halfspaces <-
...
#' @describeIn halfspaces validate structure of halfspaces object
